...
TreeNode.prototype.query = function queryBounds(bounds, results, sourceArray) {
  ...
  this.nw.query(bounds, results, sourceArray);
  this.ne.query(bounds, results, sourceArray);
  this.sw.query(bounds, results, sourceArray);
  this.se.query(bounds, results, sourceArray);
};
